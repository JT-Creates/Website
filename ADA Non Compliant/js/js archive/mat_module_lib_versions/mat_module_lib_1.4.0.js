...
function elementsadd(){
  ...
  for(var i = 0; i <= elid; i++){ 
    if(i == elid) {
      ...
      ellist += "<li id="+(i+1)+"><div><ul><li>"+
      "<input class=val_0 type=text placeholder=color value=" + item_0[i].value + "></input></li><li>" +
      "<input class=val_1 type=text placeholder=function value=" + item_1[i].value + "></input></li><li>" +
      "<input class=val_2 type=checkbox " + item_2[i].checked + "></input></li><li>" +
      "<button id='name' onclick='draw.plot_me()'>submit</button>" +
      "</li></ul></div></li>";
    }
  };

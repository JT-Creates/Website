...
function elementsadd(){
 ...
 for(var i = 0; i <= elid; i++){ 
  if(i == elid) {
   ellist += "<div class='small_card' id=" + (i+1) + "><span> <b> " + (i+1) + " </b> </span><input class=val_0 type=text placeholder=color></input><br><input class=val_1 type=text placeholder=function></input><br><input class=val_2 type=checkbox checked></input></div></li>";
  } else {
   ellist += "<div class='small_card' id=" + (i+1) + "><span> <b> " + (i+1) + " </b> </span><input class=val_0 type=text placeholder=color value=" + item_0[i].value + "></input><br><input class=val_1 type=text placeholder=function value=" + item_1[i].value + "></input><br><input class=val_2 type=checkbox";

...
function dragElement(elmnt, elmnt2, x_loc, y_loc, elmnt3, elmnt4) {
...
class panels {
  constructor(name, width, height, x, y, pic) {
  ...
  pane_Info() {
    ...
    pane_Information.name = this.pane;
    pane_Information.height = this.old_panel_height;
    pane_Information.width = this.old_panel_width;
    pane_Information.x = this.old_penel_left;
    pane_Information.y = this.old_panel_top;

...
function dragElement(elmnt, elmnt2, x_loc, y_loc) {
  var pos1 = 0, pos2 = 0, pos3 = 0, pos4 = 0, el1ofst = elmnt.offsetTop, el1ofsl = elmnt.offsetLeft, el2ofst = elmnt2.offsetTop, el2ofsl = elmnt2.offsetLeft;
  ...
  function elementDrag(e) {
    ...
    pos3 = e.clientX;
    pos4 = e.clientY;
    //console.log("mouse x-cord: "+pos3);
    //console.log("mouse y-cord: "+pos4);
    //console.log("element x-cord offset: "+pos1);
    //console.log("element y-cord offset: "+pos2);
    // set the element's new position:
    var pos5 = (pos3 - el1ofsl); pos6 = (pos4 - el1ofst);
    console.log("element x-cord: "+pos5);
    console.log("element y-cord: "+pos6);
    var c_width = window.innerWidth * 0.8 - el1ofst;
    if(y_loc){ elmnt.style.top = pos6 + "px"; };
    if(x_loc == true && pos5 <= c_width){ elmnt.style.left = pos5 + "px"; } else { elmnt.style.left = c_width + "px";};
    // set the second element's new position:
    if(y_loc){ elmnt2.style.top = elmnt.clientY + "px"; };
    if(x_loc == true && pos5 <= c_width){ elmnt2.style.left = elmnt.clientX + "px"; } else { elmnt2.style.left = c_width + "px";};
  }

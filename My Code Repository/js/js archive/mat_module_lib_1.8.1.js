...
class panels {
 ...
 edit_Pane() {
  ...
  this.panel.style.height = this.panel_height;
  this.panel.style.width = this.panel_width;
  this.panel.style.left = this.new_penel_left;
  this.panel.style.top = this.new_panel_top;
